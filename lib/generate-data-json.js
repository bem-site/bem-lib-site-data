...
// TODO: check args
module.exports = function(pathToLibData, lib, version, langs, pathToLib) {
    ...
    return new Promise(function(resolve, reject) {
        docsWalker
            .on('data', function(item) {
                ...
                sets[set][block][item.tech] = item.path;
            })
            ...
            .on('end', function() {
                ...
                var libDocs = getLibDocs(pathToLib, langs);

                Object.assign(result[lib][version], libDocs);
